...
namespace XMLLOADING
{
    class Program
    {
        private static void Xmldemo()
        {
            ...
            xmld.Load(@"C:\Users\Admin\Desktop\Sam-Dotnet\XMLLOADING\XMLLOADING\XMLFile1.xml");
        ...
        static void Main(string[] args)
        {
            ...
            int i = 0;
            string str = null;
            FileStream fs = new FileStream(@"C:\Users\Admin\Desktop\Sam-Dotnet\XMLLOADING\XMLLOADING\XMLFile1.xml",FileMode.Open,FileAccess.Read);
            xmldoc.Load(fs);
